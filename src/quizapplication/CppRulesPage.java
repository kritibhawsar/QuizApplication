...
import java.sql.*;
import java.awt.*;
public class CppRulesPage extends javax.swing.JFrame {
    public CppRulesPage() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CppRulesPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
