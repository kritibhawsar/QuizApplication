...
import java.sql.*;
import java.awt.*;
public class CRulesPage extends javax.swing.JFrame {
    public CRulesPage() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CRulesPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CRulesPage().setVisible(true);
            }
        });
    }
